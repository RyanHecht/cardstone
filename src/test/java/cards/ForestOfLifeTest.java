...
public class ForestOfLifeTest {
	...
	public void test() {
		...
		CheapJoshCreature activeJoshCr = new CheapJoshCreature(active);
		CheapJoshCreature inactiveJoshCr = new CheapJoshCreature(inactive);
		EarthswornObserver toBeHealed = new EarthswornObserver(active);

		// play the aura.
		SummonEffect auraSummon = new SummonEffect(activeHealer, Zone.AURA_BOARD, null);
		...
		AddToOccEffect ae1 = new AddToOccEffect(activeJoshCr, active, Zone.CREATURE_BOARD, Zone.HAND, null);
		AddToOccEffect ae2 = new AddToOccEffect(inactiveJoshCr, active, Zone.CREATURE_BOARD, Zone.HAND, null);
		AddToOccEffect ae3 = new AddToOccEffect(toBeHealed, active, Zone.CREATURE_BOARD, Zone.HAND, null);
		...
		System.out.println("FOREST OF LIFE PLAYER HAS THIS MUCH HEALTH: " + active.getLife());
