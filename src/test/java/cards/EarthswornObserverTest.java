...
public class EarthswornObserverTest {
	...
	public void testObserver() {
		...
		CheapJoshCreature activeToDie = new CheapJoshCreature(active);
		CheapJoshCreature inactiveToDie = new CheapJoshCreature(inactive);
		...
		SummonEffect se2 = new SummonEffect(inactiveToDie, Zone.CREATURE_BOARD, null);
		...
		CardDamageEffect dc1 = new CardDamageEffect(null, (CreatureInterface) activeToDie, 3);
		CardDamageEffect dc2 = new CardDamageEffect(null, (CreatureInterface) inactiveToDie, 3);
