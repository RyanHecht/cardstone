    ...
    <div class="col-sm-6 col-md-4 col-md-offset-4">
        <form class="form-signin whiteBg blackColor" method="post">
           ...
           <div class="form-group" id="login-fields">
             ...
             <input type="password" id="password" name="password" class="form-control blackColor" placeholder="Password" required>
           </div>
           <input type="submit" class="btn btn-lg btn-default btn-block blackColor" value="Sign In" />
        </form>
    </div>
  </div>
</div>
