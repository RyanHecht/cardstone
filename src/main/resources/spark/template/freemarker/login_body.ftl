...
<div class="container loginContainer">
  <div class="row">
    <div class="col-sm-6 col-md-4 col-md-offset-4">
        <div class="form-signin whiteBg blackColor">
           ...
           <input type="submit" id="/login" class="btn btn-default btn-block blackColor" value="Login" />
           <input type="submit" id="/register" class="btn btn-default btn-block blackColor" value="Register" />
        </div>
    </div>
  </div>
</div>
