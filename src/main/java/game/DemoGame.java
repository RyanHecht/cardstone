...
public class DemoGame extends Game {
  ...
  public DemoGame(int playerOneId) {
    ...
    messages[1] = "Play the Water Spirit from your hand by dragging it anywhere on your side of the board.";
    messages[2] = "End your turn by clicking the 'End Turn' button in the middle of your screen. Unfortunately, creatures "
