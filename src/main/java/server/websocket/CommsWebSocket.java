...
public class CommsWebSocket {
	 ...
	 * @throws IOException
	 */
	public static void sendChangedBoardSate(Board toSend, int userId) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void sendWholeBoardSate(Game toSend, int userId) throws IOException {
		if (idToSessions.containsKey(userId)) {
			Session session = idToSessions.get(userId);
			JsonObject obj = new JsonObject();
