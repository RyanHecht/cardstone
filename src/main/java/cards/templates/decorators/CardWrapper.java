...
public class CardWrapper implements Card{
	...
	/*
	 * Note: In all the  effect producing methods, the zone represents the
	...
	// when a card targets another card
	 public Effect onCardTarget(TargetsOtherCard targetter, Card target, Zone z) {
		return internal.onCardTarget(targetter, target, z);
	}
