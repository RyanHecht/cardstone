...
public class GatherTheClouds extends SpellCard{

	private static final ManaPool	defaultCost		= new ManaPool(20, 0, 0, 0, 1, 0);
	private static final String		defaultImage	= "images/GatherTheClouds.jpg";
	private static final String		defaultName		= "Gather The Clouds";
	...
	public GatherTheClouds(Player owner) {
