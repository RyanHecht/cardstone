...
public class Riptide extends SpellCard implements TargetsOtherCard {
	...
	public Riptide(ManaPool cost, String image, Player owner, String name, String text, CardType type) {
		super(defaultCost, defaultImage, owner, defaultName, defaultText, defaultType);
	}

	@Override
	public boolean cardValidTarget(Card card, Zone targetIn) {
		if (card instanceof Creature && !(card.getOwner().equals(this.getOwner())) && targetIn == Zone.CREATURE_BOARD) {
