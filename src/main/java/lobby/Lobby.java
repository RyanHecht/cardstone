...
public class Lobby implements Jsonifiable {
	 ...
	 * 
	 * @param name
	 *          The name this lobby should have.
	 * @param priv
	 *          Whether this lobby should be private.
	 * @param password
	 *          The password (empty if not private).
	 * @param hostUId
	 ...
	 * @param password
	 *          their proposed password ("" for non-private).
	 * @throws IllegalArgumentException
	 *           thrown if there's an issue joining.
	 */
	...
	public void joinSpectator(int spectatorId, String pw) throws IllegalArgumentException {
		if (priv) {
			if (!(this.password.equals(pw))) {
				throw new IllegalArgumentException("Incorrect password.");
			}
	 ...
	 * 
	 * @param uId
	 *          The uID of the player to leave.
	 */
	...
	public void beginGame() {
		if (isFull() && decksSet()) {
			...
			System.out.println(String.format("Game made with id %d and users %d and %d", 
	 ...
	 * 
	 * @param uId
	 *          The user id to set the deck of.
	 * @param deck
	 *          The deck to set.
	 */
